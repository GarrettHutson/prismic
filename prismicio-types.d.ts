...
type HomepageDocumentDataSlicesSlice = TextImageSlice | HeroSlice;
 ...
 * Primary content in *TextImage → Primary*
 */
export interface TextImageSliceTextLeftPrimary {
  /**
   * Heading field in *TextImage → Primary*
   *
   * - **Field Type**: Title
...
/**
 * Text Left variation for TextImage Slice
 *
 * - **API ID**: `textLeft`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TextImageSliceTextLeft = prismic.SharedSliceVariation<
  "textLeft",
  Simplify<TextImageSliceTextLeftPrimary>,
  never
>;
 ...
 * Primary content in *TextImage → Primary*
 */
export interface TextImageSliceTextRightPrimary {
  /**
   * Heading field in *TextImage → Primary*
   *
   * - **Field Type**: Title
...
/**
 * Text Right variation for TextImage Slice
 *
 * - **API ID**: `textRight`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TextImageSliceTextRight = prismic.SharedSliceVariation<
  "textRight",
  Simplify<TextImageSliceTextRightPrimary>,
  never
>;
...
type TextImageSliceVariation =
  ...
  | TextImageSliceTextLeft
  | TextImageSliceTextRight;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TextImageSliceTextLeftPrimary,
      TextImageSliceTextRightPrimary,
      TextImageSliceVariation,
      TextImageSliceDefault,
      TextImageSliceTextLeft,
      TextImageSliceTextRight,
